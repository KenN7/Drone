...
SOURCEFILES_QUOTED_IF_SPACED=main.c inputcapt.c outputcompare.c accelgyro.c i2c_func.c T1-init-filter.c pid-motorcontrol.c uart.c
...
# Source Files
SOURCEFILES=main.c inputcapt.c outputcompare.c accelgyro.c i2c_func.c T1-init-filter.c pid-motorcontrol.c uart.c
